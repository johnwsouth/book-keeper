    ...
    <div className="header-padding">
      <div className="header-container">
        ...
        <div className="entry-average">
          ...
          {!isNaN(props.getProductAverage()) && <div className="header-entry-average d-inline-block ml-5 mr-5">Product Average Price: <div className="average-entry-box d-inline-block badge">{'$ ' + (props.getProductAverage() / 100).toFixed(2)}</div></div>}
        </div>
        <Link to='/chart'><i className="far fa-chart-bar nav-icon mr-5 mt-3"></i></Link>
        <Link to='/calendar'><i className="far fa-calendar-alt nav-icon mr-5 mt-3"></i></Link>
      </div>
    </div>
  );
